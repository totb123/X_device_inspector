import type { GlobalToken } from 'antd/lib/theme';
import type { AliasToken, FullToken, GenerateStyle } from 'antd/lib/theme/internal';
import type { GenStyleFn, TokenWithCommonCls } from 'antd/lib/theme/util/genComponentStyleHook';
...
declare const _default: (prefixCls: string) => import("antd/lib/theme/interface").UseComponentStyleResult;
