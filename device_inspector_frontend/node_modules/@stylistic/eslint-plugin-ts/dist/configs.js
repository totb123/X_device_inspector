...
const KNOWN_NODES = /* @__PURE__ */ new Set([
  ...
  utils$1.AST_NODE_TYPES.TSIntersectionType,
  ...
  utils$1.AST_NODE_TYPES.TSUnionType,
...
const StatementTypes = {
  ...
  "type": newKeywordTester(utils$1.AST_NODE_TYPES.TSTypeAliasDeclaration, "type")
};
...
var spaceInfixOps = utils.createRule({
  ...
  create(context) {
    ...
    function checkForTypeAnnotationSpace(typeAnnotation) {
      ...
      types.forEach((type) => {
        const skipFunctionParenthesis = type.type === utils$1.TSESTree.AST_NODE_TYPES.TSFunctionType ? astUtils.isNotOpeningParenToken : 0;
